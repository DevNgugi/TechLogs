    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
             ...
             <!-- role id -->
             <div class="mt-4">
                <x-label for="role" :value="__('Role id')" />
             ...
             <!-- role id -->
             <div class="mt-4">
                <x-label for="station" :value="__('Station')" />

                <x-input id="station" class="block mt-1 w-full" type="text" name="station" :value="old('station')" required />
            </div>
